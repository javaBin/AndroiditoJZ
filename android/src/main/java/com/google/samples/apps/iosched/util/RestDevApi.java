...
public interface RestDevApi {
    ...
    @POST("/devnull/server/events/{eventId}/sessions/{sessionId}/feedbacks")
    ...
    @Headers("Content-Type: application/json")
    @POST("/devnull/server/events/58b3bfaa-4981-11e5-a151-feff819cdc9f/sessions/58b3c298-4981-11e5-a151-feff819cdc9f/feedbacks")
